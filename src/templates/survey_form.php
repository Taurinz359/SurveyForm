...
<div class="bg-image text-white"
     style="background-color:rgba(red, green, blue, alpha); background-image:linear-gradient(115deg, rgba(3, 60, 245,0.8),rgba(17, 240, 248,0.8)), url('https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg'); min-height: 100vh; display: flex;flex-direction: column;">
    <div class="header">
